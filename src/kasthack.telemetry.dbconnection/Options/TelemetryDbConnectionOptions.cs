...
public sealed class TelemetryDbConnectionOptions
{
    ...
    /// <summary>
    /// Gets or sets which command types have their <c>db.statement</c> tag included in traces and metrics.
    /// Limit to avoid recording potentially sensitive SQL text. Default is <see cref="CaptureStatements.StoredProcedures"/>.
    /// </summary>
    public CaptureStatements CaptureStatements { get; set; } = CaptureStatements.StoredProcedures;
